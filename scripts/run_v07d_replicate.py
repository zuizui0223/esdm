#!/usr/bin/env python3
"""Run one frozen v0.7d static-versus-dynamic replicate."""
...
def _parser():
    parser = argparse.ArgumentParser(description="Run one frozen v0.7d replicate.")
...
def _seed(index: int) -> int:
    ...
    if not 0 <= value < FROZEN_REPLICATES:
        raise ValueError("replicate outside frozen v0.7d range")
...
def main() -> int:
    from esdm.validate.v07d_run import run_v07d_replicate
