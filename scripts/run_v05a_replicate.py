#!/usr/bin/env python3
"""Run one frozen v0.5a directed interaction replicate."""
...
def _parser():
    parser = argparse.ArgumentParser(description="Run one frozen v0.5a replicate.")
...
def main() -> int:
    from esdm.validate.v05a_run import run_v05a_replicate
