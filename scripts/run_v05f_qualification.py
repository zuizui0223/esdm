#!/usr/bin/env python3
"""Run frozen pre-MCMC v0.5f identification qualification."""
...
def _parser():
    parser = argparse.ArgumentParser(description="Run frozen v0.5f qualification.")
...
def main() -> int:
    ...
    base = {
        "schema": "esdm.v05f.qualification.v1",
