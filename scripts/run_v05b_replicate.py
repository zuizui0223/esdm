#!/usr/bin/env python3
"""Run one frozen v0.5b hidden-driver replicate."""
...
FROZEN_GATE_COMMIT = "06c6943de8cfa5a2edb8b9ecd7bde05ebb661fa5"
FROZEN_GATE_BLOB_SHA = "ba1ff83cabf402b98ea4fd7a3e097adcb06b5fd6"
GATE_PATH = (
...
def _parser():
    parser = argparse.ArgumentParser(description="Run one frozen v0.5b replicate.")
...
def _seed(replicate: int) -> int:
    ...
    if not 0 <= index < FROZEN_REPLICATES:
        raise ValueError("replicate outside frozen v0.5b range")
    return FROZEN_BASE_SEED + FROZEN_SEED_STRIDE * index
...
def main() -> int:
    from esdm.validate.v05b_run import run_v05b_replicate
