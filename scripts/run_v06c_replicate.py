#!/usr/bin/env python3
"""Run one frozen v0.6c budget-matched replicate."""
...
def _parser():
    parser = argparse.ArgumentParser(description="Run one frozen v0.6c replicate.")
...
def _seed(index):
    ...
    if not 0 <= value < FROZEN_REPLICATES:
        raise ValueError("replicate outside frozen v0.6c range")
...
def main() -> int:
    from esdm.validate.v06c_run import run_v06c_replicate
