#!/usr/bin/env python3
"""Run one frozen v0.5f interaction-transfer replication."""
...
def _parser():
    parser = argparse.ArgumentParser(description="Run one frozen v0.5f replicate.")
...
def main() -> int:
    from esdm.validate.v05f_run import run_v05f_replicate
