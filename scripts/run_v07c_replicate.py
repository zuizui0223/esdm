#!/usr/bin/env python3
"""Run one frozen v0.7c static-versus-dynamic replicate."""
...
def _parser():
    parser = argparse.ArgumentParser(description="Run one frozen v0.7c replicate.")
...
def _seed(index: int) -> int:
    ...
    if not 0 <= value < FROZEN_REPLICATES:
        raise ValueError("replicate outside frozen v0.7c range")
...
def main() -> int:
    from esdm.validate.v07c_run import run_v07c_replicate
