#!/usr/bin/env python3
"""Run frozen pre-MCMC v0.7b dynamic qualification."""
...
FROZEN_GATE_COMMIT = "e1f805c6681d33bfc92758b2cdf9d95673353ccc"
FROZEN_GATE_BLOB_SHA = "b0f721ac334a2e76e0387510f5a889980eaefe53"
GATE_PATH = (
...
def _parser():
    parser = argparse.ArgumentParser(description="Run frozen v0.7b qualification.")
...
def _verify_gate():
    ...
    if observed != FROZEN_GATE_BLOB_SHA:
        raise RuntimeError(
            f"v0.7b gate blob mismatch: expected {FROZEN_GATE_BLOB_SHA}, "
            f"observed {observed}"
        )
    return observed
...
def main() -> int:
    ...
    base = {
        "schema": "esdm.v07b.qualification.v1",
    ...
    passed = all((
        result.positive_structural_pass,
        result.positive_practical_pass,
        result.joint_only_refusal_pass,
    ))
    payload = {
        **base,
