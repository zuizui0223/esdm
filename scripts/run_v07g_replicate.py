#!/usr/bin/env python3
"""Run one frozen v0.7g calibration-placement validation replicate."""
...
def _parser():
    parser = argparse.ArgumentParser(description="Run one frozen v0.7g replicate.")
...
def _seed(index: int) -> int:
    ...
    if not 0 <= value < FROZEN_REPLICATES:
        raise ValueError("replicate outside frozen v0.7g range")
...
def main() -> int:
    from esdm.validate.v07g_run import run_v07g_replicate
