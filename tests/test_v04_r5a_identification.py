...
R5A_OUTCOME_ENABLED = os.environ.get("ESDM_RUN_R5A_QUALIFICATION") == "1"
...
@pytest.mark.skipif(
    not JAX_AVAILABLE or not R5A_OUTCOME_ENABLED,
    reason="R5a outcome test requires explicit authorization environment",
)
def test_r5a_evaluator_returns_frozen_evidence_shape():
    from esdm.validate.v04_r2_gate import R2_IDENTIFICATION_TARGETS
    from esdm.validate.v04_r5a_gate import evaluate_v04_r5a_identification

    result = evaluate_v04_r5a_identification(_sample_csv())
