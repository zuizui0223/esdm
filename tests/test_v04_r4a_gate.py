...
def _passing_summary():
    from esdm.validate.v04_r4a_gate import V04R4AQualificationSummary
    ...
    return V04R4AQualificationSummary(
        ...
        r3_spatial_sequence_preserved=True,
        phase_balance_preserved=True,
    )


def test_r4a_mechanical_gate_requires_complete_qualification():
    from esdm.validate.v04_r4a_gate import evaluate_v04_r4a_qualification

    decision = evaluate_v04_r4a_qualification(_passing_summary())
...
def test_r4a_each_gate_term_is_required():
    from esdm.validate.v04_r4a_gate import evaluate_v04_r4a_qualification
    ...
    cases = {
        ...
        "r3_spatial_sequence_preserved": False,
        "phase_balance_preserved": False,
    }
    for field, value in cases.items():
        decision = evaluate_v04_r4a_qualification(
...
def test_r4a_gate_keeps_r2_budget_thresholds():
    from esdm.validate.v04_r4a_gate import evaluate_v04_r4a_qualification
