...
def _load_script():
    path = (
        ...
        / "scripts"
        / "run_v04_r4a_qualification.py"
    )
    spec = importlib.util.spec_from_file_location(
        "run_v04_r4a_qualification",
        path,
    )
...
def test_r4a_script_freezes_gate_and_budget_constants():
    module = _load_script()

    assert module.FROZEN_GATE_COMMIT == "65115f31425d4d8655137eeea9a0bdb40f56aa53"
    assert module.FROZEN_GATE_BLOB_SHA == "c55af9dfbc6347218fecebb27542ee7bb59310b0"
...
def test_r4a_script_has_no_scientific_override_flags():
    module = _load_script()
...
def test_r4a_initial_payload_fails_closed():
    module = _load_script()
