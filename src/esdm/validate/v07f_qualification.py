"""Candidate-model qualification for v0.7f robustness programme."""
...
def evaluate_v07f_identification() -> V07FQualification:
    source = evaluate_v07d_identification()
    return V07FQualification(
